...
namespace NarrativeProject
{
    ...
    internal class Program
    {
        ...
        private static void UseMedkit(ref int playerHP)
        {
            if (!medkitUsed)
            {
                playerHP += 45;
                Console.WriteLine("You used a medkit and restored 45 health points. Your current health is {0}.", playerHP);
                medkitUsed = true; // Set the medkitUsed flag to true after using the medkit
            }
            else
            {
            ...
            while (completedRooms.Count < 6) // Change '>' to '<' to ensure loop runs until 5 rooms are completed
            {
                ...
                switch (room.ToLower())
                {
                    case "red":
                        Console.Clear();
                        Console.WriteLine("===============================================");
                        Console.WriteLine("You entered the red room.");
